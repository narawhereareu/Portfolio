...
export default function MainPage() {
  return (
    <div className="max-w-6xl w-full" data-aos="fade-up">
      ...
      <p className="text-gray-600 text-xl max-w-3xl mb-8 leading-relaxed">
        A Full-stack developer that chage carrer path to tech jobs, specializing in modern web applications, 
